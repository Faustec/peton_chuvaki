...
def main():
    ...
    login, password = "+79538237454", "$FenderDERTER19920212"
    ...
    try:
        ...
        #response = vk.wall.get(count=3, owner_id=26377560)  #Используя vk api получаем первую запись со стены керила (документация по api вот тут https://vk.com/dev/wall.get)
